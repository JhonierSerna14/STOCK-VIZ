<template>
  <div class="container mx-auto p-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-8 border border-gray-100">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div>
          ...
          <select id="rating" v-model="filters.rating"
        ...
        <!-- Límite -->
        <div>
          <label for="limit" class="block text-sm font-medium text-gray-700 mb-1">Cantidad</label>
          <input type="number" id="limit" v-model.number="filters.limit" min="1" max="50"
            class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-300 focus:border-blue-500 focus:outline-none transition duration-200" />
        </div>
    ...
    <div v-else-if="error" class="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded-lg shadow-sm my-4">
    ...
    <div v-if="!recommendations" class="text-center py-12 bg-white rounded-lg shadow-md">
    ...
    <div v-else-if="recommendations.length === 0" class="text-center py-12 bg-white rounded-lg shadow-md">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto text-gray-400 mb-4" fill="none"
        viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
      <div v-for="recommendation in recommendations" :key="recommendation.ticker"
        ...
        <div class="flex justify-between items-start mb-4 pb-3 border-b border-gray-100">
          <div>
            <div class="flex items-center">
              ...
              <span class="text-xs px-2 py-1 rounded-full uppercase font-bold tracking-wider"
          ...
          <div class="bg-gray-50 rounded-lg p-3 shadow-inner">
            <div class="text-center">
              ...
              <div class="text-2xl font-bold rounded-full w-12 h-12 flex items-center justify-center mx-auto"
